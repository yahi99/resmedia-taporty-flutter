...
class _DetailOrderRestaurantPageState extends State<DetailOrderRestaurantPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<RestaurantOrderModel>(
      stream: Database()
          .getRestaurantOrder(widget.model.restaurantId, widget.model.id),
      builder: (ctx, order) {
        if (!order.hasData)
          return Center(
                    ...
                    Wrap(
                      ...
                      children: <Widget>[
                        ...
                        (translateOrderCategory(order.data.state) !=
                            ...
                            : Container(),
                        Text('Indirizzo cliente: ', style: tt.subtitle),
                        ...
                        ListView.separated(
                            ...
                            itemBuilder: (BuildContext ctx, int index) {
                              return ProductView(
                                  model: cart.products.elementAt(index),
                                    ...
                                    onPressed: () {
                                      ...
                                      CloudFunctions.instance
                                        ...
                                        CloudFunctions.instance
                                          ...
                                          'state': 'ACCEPTED',
                                          'oid': widget.model.id,
                                          'rid': widget.model.products.first
                                              .restaurantId,
                                          'timeS':
...
class ProductView extends StatelessWidget {
  ...
  ProductView({Key key, @required this.model, @required this.number})
      : super(key: key);
