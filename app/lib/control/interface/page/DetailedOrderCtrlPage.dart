...
class _DetailOrderRestaurantPageState extends State<DetailOrderCtrlPage> {
  ...
  Future<String> isAvailable(
      String date, String time, String restId, UserModel driver) async {
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                        onPressed: () {
                          isAvailable(widget.model.day, widget.model.startTime,
                              widget.model.restaurantId, driverModel);
                          Database()
                              .updateOrderDriver(widget.model, driverModel.id)
                              .then((value) {
                          ...
                          StreamBuilder<List<UserModel>>(
                            ...
                            builder: (ctx, drivers) {
                              if (drivers.hasData) {
                                ...
                                return Text('Non ci sono fattorini.');
                            },
                          ),
                          RaisedButton(
                            child: Text('Assegna'),
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          RaisedButton(
                            child: Text('Cambia'),
                            onPressed: () {
                              if (state != translateOrderCategory(model.state))
                                Database()
                                    .updateState(
                                        state,
                                        widget.model.uid,
                          ...
                          !model.isPaid
                              ? RaisedButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    for (int i = 0;
                                        i < widget.model.products.length;
                                        i++) {
                                      if (widget.model.products
                                              .elementAt(i)
                                              .category ==
                                          'foods') {
                                        for (int j = 0;
                                            j <
                                                widget.model.products
                                                    ...
                                                    .countProducts;
                                            j++)
                                          foodIds.add(widget.model.products
                                              .elementAt(i)
                                              .id);
                                      } else {
                                        for (int j = 0;
                                            j <
                                                widget.model.products
                                                    ...
                                                    .countProducts;
                                            j++)
                                          drinkIds.add(widget.model.products
                                              .elementAt(i)
                                              .id);
                                      }
                                    }
