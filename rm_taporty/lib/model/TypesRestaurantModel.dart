...
class TypesRestaurantModel extends FirebaseModel {
  ...
  TypesRestaurantModel({@required String path,
    @required this.img}) : super(path);

  static TypesRestaurantModel fromJson(Map json) => _$TypesRestaurantModelFromJson(json);
