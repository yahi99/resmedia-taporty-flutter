...
class SuppliersBloc implements Bloc {
  ...
  fetchAvailableStartTimes(DateTime date, String driverId) async {
    ...
    for (var supplier in suppliers) {
      if ((await DistanceHelper.fetchAproximateDistance(supplier.geohashPoint.geopoint, driver.geohashPoint.geopoint)) <= driver.areaId * 1000) filteredSuppliers.add(supplier);
    }
