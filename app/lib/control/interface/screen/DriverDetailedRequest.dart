            ...
            Container(
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                    child: Container(
                      child: Text(widget.model.nominative),
                    ),
                  ),
                ],
              ),
            ...
            Container(
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                    child: Container(
                      child: Text(widget.model.experience),
                    ),
                  ),
                ],
              ),
            ...
            Container(
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                    child: Container(
                      child: Text(widget.model.codiceFiscale),
                    ),
                  ),
                ],
              ),
                ...
                RaisedButton(
                  onPressed: () {
                    ...
                    if (!widget.isArchived)
                      Database().archiveDriver(widget.model);
                    else {
