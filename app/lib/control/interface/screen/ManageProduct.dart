...
class ManageProduct extends StatefulWidget implements WidgetRoute {
  ...
  ManageProduct({@required this.prod});
                  ...
                  children: <Widget>[
                    Container(
                      child: Text('Disabilitato: ' +
                          (snapshot.data.isDisabled ? 'Si' : 'No')),
                    ...
                    Container(
                      child: Column(
                        children: <Widget>[
                          Padding(
                              child: Text(
                                  'Prezzo: ' + snapshot.data.price + ' euro'),
                        ...
                        onPressed: () async {
                          ...
                          if (path != null) {
                            if (path.split('.').last != 'jpg') {
                              Toast.show(
                                  'Il formato dell\'immagine deve essere .jpg',
                                  context,
                                  duration: 3);
                            } else {
                              ...
                              uploadFile(path).then((path) async {
                                Database()
                                    .updateProductImage(path, snapshot.data)
                                    .then((value) {
